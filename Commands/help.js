...
.addField(`+avatar`, "Shows someone's (or yours) avatar. Usage: `+avatar [user mention]`")
...
.addField(`+profile`, "Displays information of the specified account. Usage: `+profile [user mention]`")
